      ...
      <div className="flex items-center gap-2.5 sm:gap-3">
        {shareLinks.map((item) => (
          <a
            ...
            className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full ${item.bgColor} text-white flex items-center justify-center hover:opacity-90 hover:scale-105 transition-all shadow-xs`}
          >
            {item.icon}
          </a>
        ))}
